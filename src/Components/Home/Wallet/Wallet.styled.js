...
const WalletBtnDesign = (main, sub) => styled.div`
...
const WalletInsertAllBtnDiv = WalletBtnDesign('lightGreen', 'green');
const WalletWithdrawAllBtnDiv = WalletBtnDesign('lightRed', 'red');
